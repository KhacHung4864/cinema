...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      var data = Provider.of<MovieProvider>(context, listen: false);
      data.getUserInforByToken(context);
    });
  }
  ...
  static const IconData ticket = IconData(0xf916, fontFamily: 'CupertinoIcons', fontPackage: 'cupertino_icons');
...
TabItem iconItems(IconData newIcon) {
  return TabItem(newIcon, '', const Color(0xff2d0150).withAlpha(200), circleStrokeColor: Colors.greenAccent // màu hình tròn bọc icon
      );
}
