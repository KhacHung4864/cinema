              ...
              child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 41, right: 26),
                        child: Text(
                          S.of(context).Payment,
                          style: AppFonts.poppins500(18, AppTheme.white).copyWith(height: 27 / 18),
                        ),
                      ),
                      Padding(
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: AppFonts.poppins600(16, AppTheme.white).copyWith(height: 24 / 16),
                          ),
                        ),
                      ),
                      const SizedBox(
                      ...
                      Padding(padding: const EdgeInsets.only(left: 23, right: 22), child: AppButton(titleButton: S.of(context).checkout)),
                      const SizedBox(
                        height: 25,
                      ),
                      Container(
